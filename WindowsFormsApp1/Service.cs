...
namespace WindowsFormsApp1
{
    public partial class Service : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                AddClient f7 = new AddClient(this);
                f7.Show();
                Hide();
            }
        ...
        private void comboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (comboBox2.Text == "ClientService")
            {
                Table<clientService> Cservice = context.GetTable<clientService>();
                dataGridView1.DataSource = Cservice.ToList();
            }
        }
        ...
        {
            Servicee item = context.GetTable<Servicee>().OrderByDescending(x => x.id).FirstOrDefault();
            context.GetTable<Servicee>().DeleteOnSubmit(item);
